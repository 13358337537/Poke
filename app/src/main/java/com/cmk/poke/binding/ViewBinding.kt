...
import com.cmk.poke.utils.PokemonTypeUtils
import com.cmk.poke.utils.SpacesItemDecoration
...
object ViewBinding {
    ...
    fun bindToast(view : View, test: String?) {
        test.whatIfNotNullOrEmpty {
                ...
                .listener(
                        GlidePalette.with(url)
                                ...
                                .intoCallBack{
                                    ...
                                    val domain = it?.dominantSwatch?.rgb
                                    if (domain != null){
                                        if (light != null){
    ...
    fun bindProgressViewLabelText(progressView: ProgressView, test: String?){
        progressView.labelText = test
    }
